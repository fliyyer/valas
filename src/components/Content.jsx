        ...
        <div className='container mx-auto'>
            ...
            <div className='flex flex-col items-center gap-[144px] justify-center mt-8 md:flex-row md:justify-center'>
                ...
                <div className='space-y-4'>
                    <div className='flex border-2 w-[350px] mx-auto  md:w-[570px] border-[#0360D9] rounded-[15px] p-7 gap-4'>
                        <h1 className='text-2xl text-[#0A4BDB] font-bold'>1.</h1>
                        <div>
                            <h1 className='text-lg md:text-2xl text-[#000] font-bold'>Create your Valast Account</h1>
                            <p className='text-base md:text-lg text-[#505050]'>Then verify your account easily with e-KTP/passport</p>
                        </div>
                    </div>
                    <div className='flex border-2 w-[350px] mx-auto  md:w-[570px] border-[#0360D9] rounded-[15px] p-7 gap-4'>
                        <h1 className='text-2xl text-[#0A4BDB] font-bold'>2.</h1>
                        <div>
                            <p className='text-base md:text-[21px] font-bold text-[#505050]'>Choose destination country & fill in the amount you want to send</p>
                        </div>
                    </div>
                    <div className='flex border-2 w-[350px] mx-auto  md:w-[570px] border-[#0360D9] rounded-[15px] p-7 gap-4'>
                        <h1 className='text-2xl text-[#0A4BDB] font-bold'>3.</h1>
                        <div>
                            <p className='text-base md:text-[21px] font-bold text-[#505050]'>Enter recipient’s detail</p>
                        </div>
                    </div>
                    <div className='flex border-2 w-[350px] mx-auto  md:w-[570px] border-[#0360D9] rounded-[15px] p-7 gap-4'>
                        <h1 className='text-2xl text-[#0A4BDB] font-bold'>4.</h1>
                        <div>
                            <p className='text-base md:text-[21px] font-bold text-[#505050]'>Make payment & you’re all done!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className='bg-[#E8F0FD] container mx-auto px-3 py-8 md:py-24 my-8 md:my-24'>
                <div className='flex flex-col sm:flex-row justify-center items-center md:px-32'>
                    <div className='w-full sm:w-1/2 md:w-1/2'>
                        ...
                        <p className='font-poppins text-[#000] text-center md:text-justify mt-4 sm:mt-8 text-lg sm:text-base leading-[24px] sm:leading-[28px] font-medium opacity-50'>Arcu at dictum sapien, mollis. Vulputate sit id accumsan, ultricies. In ultrices malesuada elit mauris etiam odio. Duis tristique lacus, et blandit viverra nisl velit. Sed mattis rhoncus, diam suspendisse sit nunc, gravida eu. Lectus eget eget ac dolor neque lorem sapien, suspendisse aliquam.</p>
                    </div>
                    <img src={Web} className='' alt="" />
                </div>
                <div className='flex flex-col-reverse sm:flex-row px-3 justify-center items-center mt-8 sm:mt-32 md:px-32'>
                    ...
                    <div className='w-full md:w-1/2'>
                        ...
                        <p className='font-poppins text-[#000] mt-4 text-center md:text-justify sm:mt-8 text-lg sm:text-base leading-[24px] sm:leading-[28px] font-medium opacity-50'>Arcu at dictum sapien, mollis. Vulputate sit id accumsan, ultricies. In ultrices malesuada elit mauris etiam odio. Duis tristique lacus, et blandit viverra nisl velit. Sed mattis rhoncus, diam suspendisse sit nunc, gravida eu. Lectus eget eget ac dolor neque lorem sapien, suspendisse aliquam.</p>
                    </div>
                </div>
            </div>
        </div>
