            ...
            <div className='flex flex-col sm:flex-row justify-center items-center'>
                <div className='w-full sm:w-1/2 md:w-1/2' data-aos='fade-right' data-aos-duration='2500'>
                    <div className='flex items-center gap-[15px]'>
                        ...
                        <h1 className='font-poppins text-2xl md:text-[28px] font-extrabold'>{t('Dashboard Admin')}</h1>
                    </div>
                    <p className='font-poppins text-[#000] text-[20px] text-center md:text-justify mt-4 sm:mt-8 text-lg sm:text-base leading-[24px] sm:leading-[28px] font-medium opacity-50'>{t('Dashboard desc')}</p>
                </div>
